        ...
        <form action="" method="">
            <div class="album py-5">
                <div class="container">
                    ...
                    <div class="mb-3 row">
                        <label for="inputBirthday" class="col-sm-2 col-form-label">Data de Nascimento</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="inputBirthday">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputOcupation" class="col-sm-2 col-form-label">Ocupação</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputOcupation">
                        </div>
                    </div>
                    <div class="mb-3 row">
